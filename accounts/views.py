...
class LecturerListView(ListView):
    queryset = User.objects.filter(is_lecturer=True).order_by('first_name', 'last_name', 'username')
...
class StudentListView(ListView):
    ...
    def get_queryset(self):
        queryset = Student.objects.select_related('student', 'department').order_by(
